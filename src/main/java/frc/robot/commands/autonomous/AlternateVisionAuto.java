...
public class AlternateVisionAuto extends SequentialCommandGroup {
  ...
  public AlternateVisionAuto(DriveSubsystem driveSubsystem, IntakeSubsystem intakeSubsystem, VisionSubsystem visionSubsystem) {
    ...
    addCommands(
      ...
      AlternateVizAuto_1.getCommandAndStop().deadlineWith(new ManualIntakeCommand(intakeSubsystem)),
