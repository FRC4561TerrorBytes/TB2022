...
public class ShooterSubsystem extends SubsystemBase implements AutoCloseable {
  ...
  public static class Hardware {
    ...
    public Hardware(WPI_TalonFX flywheelMasterMotor, WPI_TalonFX flywheelSlaveMotor) {
  ...
  public static Hardware initializeHardware() {
    return new Hardware(new WPI_TalonFX(Constants.FLYWHEEL_MASTER_MOTOR_PORT),
