...
public class IntakeSubsystemTest {
	...
	public void setup() {
		...
		GenericHID mockController = mock(GenericHID.class);
		...
		m_intakeSubsystem = new IntakeSubsystem(m_intakeHardware, Constants.INTAKE_ARM_CONFIG, Constants.INTAKE_ROLLER_SPEED, mockController);
	}
